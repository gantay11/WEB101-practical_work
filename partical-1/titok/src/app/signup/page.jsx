...
export default function SignupPage() {
    ...
    const onSubmit = async (data) => {
        setIsLoading(true);
        // In a real app, you would call an registration API here
        ...
        <div className="min-h-screen flex-items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                <div className="text-center">
                    <h2 className="text-2xl font-extrabold texts-gray-900">sign up for TikTok</h2>
                    <p classname="mt-2 text-sm text-gray-600"
                    >Create a profile, follow other accounts, make your own videos, and more</p>
                </div>
                        ...
                        <div className="mb-4">
                           ...
                           <div>
                            ...
                            <div className="flex items-center">
                                ...
                                id="terms"
                                type="checkbox"
                                className="h-4 w-4 text-red-600 forcus:ring-red-500 border-gray-300 rounded"
                                {...register('terms', {
                                        ...
                                        <a href="#" className="font-medium text-red-600 hover:text-red-500">
                                            ...
                                            <div>
                                                ...
                                                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md
                                                 ■text-white bg-red-600hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2focus: ring-red-500"
                                                 disabled={isLoading}
                                                 >
